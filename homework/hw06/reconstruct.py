...
def main():
    ...
    operator = aomip.XrayOperator(fconfig["volshape"], fconfig["sinoshape"], fconfig["angles"], fconfig["ds2c"], fconfig["dc2d"])
    fsino = aomip.radon(fdata, fconfig["sinoshape"], fconfig["angles"], fconfig["ds2c"], fconfig["dc2d"])
    qsino = aomip.radon(qdata, qconfig["sinoshape"], qconfig["angles"], qconfig["ds2c"], qconfig["dc2d"])
    lr, n = 1e-3, 100
    for i in range(n):
