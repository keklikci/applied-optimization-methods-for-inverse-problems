...
* Additionally, I moved some leftover scripts to the top-level directory for completeness of my work. I also accounted for backward compatibility of these scripts. Even though I had implemented all these methods, this is a by-far better software engineering approach. I did this while correcting / adjusting some of those methods such as accounting for lazy parameter selection and regularization. Therefore, I was able to get significantly higher scores than the [Vanilla SGD](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/gradient.py) as this was till this assignment my most performing one. I learned along my mistakes, particularly the last 3 weeks of the Praktikum with proximal methods and was able to score particulary higher scores than what was being claimed in previous homeworks such as [hw04](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/bb1.py).

    * [BB1](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/bb1.py)
    * [BB2](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/bb2.py)
    * [LADMM = LASSO + ADMM](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/ladmm.py)
    * [POGM](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/pogm.py)
    * [FPGM](https://gitlab.lrz.de/IP/teaching/applied-optimization-methods-for-inverse-problems/aomip-kaan-guney-keklikci/-/blob/main/aomip/fpgm.py)
