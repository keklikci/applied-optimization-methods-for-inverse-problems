...
def test_tikhonov_opt(output_path: str, learning_rate: float = 0.0005, n_iterations: int = 100_000) -> None:
    volume_shape = [128, 128]
    sinogram_shape = [128]
    d2c = volume_shape[0] * 100.0
    c2d = volume_shape[0] * 5.0
    ...
    os.makedirs(output_path, exist_ok = True)
    plt.savefig(os.path.join(output_path, "tikhonov_regularization.png"), transparent = True)
